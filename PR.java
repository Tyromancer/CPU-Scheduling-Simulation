...
public class PR {
    ...
    public PR() {
        ...
        this.readyQueue = new PriorityQueue<Process>(new Comparator<Process>() {
			...
			public int compare(Process p1, Process p2) {
				int e1 = p1.burstIndex();
				int e2 = p2.burstIndex();
				if(e1 == e2)
    ...
    public String runSimulation() {
        String result = "Algorithm PR\n";
        System.out.println("time 0ms: Simulator started for PR [Q <empty>]");
        ...
        System.out.println(String.format("time %dms: Simulator ended for PR %s", time, queueInfo()));
        int burstNum = 0;
